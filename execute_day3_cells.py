#!/usr/bin/env python3
"""Execute all code cells in Day 3 notebook and save outputs"""
...
# Cells to execute (excluding TODOs at indices 36, 38, 40)
# Cell indices in notebook.cells array
cells_to_execute = [4, 5, 7, 9, 11, 14, 17, 19, 20, 23, 25, 27, 29, 31, 32, 34]
