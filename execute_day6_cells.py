#!/usr/bin/env python3
"""Execute all code cells in Day 6 notebook and save outputs"""
...
# Cells to execute (excluding TODOs at indices 29, 31, 33, 35)
cells_to_execute = [3, 6, 7, 9, 11, 13, 14, 15, 17, 19, 21, 23, 24, 26]
