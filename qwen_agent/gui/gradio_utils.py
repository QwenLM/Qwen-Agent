...
def format_cover_html(bot_name, bot_description, bot_avatar):
    ...
    safe_name = html.escape(bot_name or "")
    safe_description = html.escape(bot_description or "")
...
<div class="bot_cover">
    ...
    <div class="bot_name">{safe_name}</div>
    <div class="bot_desp">{safe_description}</div>
</div>
"""
